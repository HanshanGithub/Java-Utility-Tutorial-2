...
public class Example4_22 {
   public static void main(String args[]) {
		...
		ratio.setDenominator(8);
		//System.out.println(ratio.getDenominator());
		//System.out.println(ratio.getNumerator());
		Rational ratio1 = new Rational();
		ratio.setNumerator(6);
		ratio.setDenominator(8);
		Rational ratio2 = ratio.add(ratio1);
		System.out.println(ratio2.getNumerator());
		System.out.println(ratio2.getDenominator());
